...
<h1 class="text-2xl text-center font-bold mb-4">All Tasks</h1>
...
<button type="submit" class="bg-black text-center text-white px-4 py-2 ml-2 rounded hover:bg-gray-500">
Search & Sort
</button>
</form>
<ul>
...
class="bg-black text-white text-center px-4 py-2 rounded hover:bg-gray-500">
Create a New Task
</a>
</div>
@endsection
